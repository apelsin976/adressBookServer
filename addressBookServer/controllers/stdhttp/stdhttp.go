...
func createpage(w http.ResponseWriter, _ *http.Request) {
...
func getpage(w http.ResponseWriter, _ *http.Request) {
...
func updatepage(w http.ResponseWriter, _ *http.Request) {
...
func deletepage(w http.ResponseWriter, _ *http.Request) {
